...
#define UNIFIED_CACHE_POOL "mysql_1"
...
#define WORKLOAD_TYPE                          \
        std::make_shared<Generator>(D_HOTSPOT, 105000, vector<double>{0.2, 0.8}),         \
        std::make_shared<Generator>(D_HOTSPOT, 210000, vector<double>{0.2, 0.8}),         \
        std::make_shared<Generator>(D_ZIPFIAN, 52500, vector<double>{0.8}),     
