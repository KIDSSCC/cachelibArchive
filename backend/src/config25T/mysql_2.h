...
#define UNIFIED_CACHE_POOL "mysql_2"
...
#define WORKLOAD_TYPE                          \
        std::make_shared<Generator>(D_HOTSPOT, 52500, vector<double>{0.4, 0.8}),         \
        std::make_shared<Generator>(D_UNIFORM, 105000, vector<double>{}),         \
