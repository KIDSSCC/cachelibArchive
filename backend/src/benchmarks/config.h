...
#define UNIFIED_CACHE_POOL "mysql_uniform_test"
...
#define MAX_FIELD_SIZE 1024 // size of each field (in chars)
#define MAX_QUERIES 50000 // number of queries to execute
